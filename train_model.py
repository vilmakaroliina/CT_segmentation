...
#from datapreparation import Dataset #this doesn't exist yet, but the data have to be prepared
...
if __name__ == "__main__":
    ...
    train_dataset = Dataset(DATA_PATH) #not working yet as the data preparation isn't done
    
    #divide the set to train and validation
    generator = torch.Generator().manual_seed(42) #to ensure the reproductibility, I could also just store the data to different places
    train_set, val_set = random_split(train_dataset, [0.8, 0.2], generator = generator)
    
    #create the dataloaders
    train_dataloader = DataLoader(dateset = train_set,
